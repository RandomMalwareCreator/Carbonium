...
# Função para desligar o computador após 1 segundo
def shutdown_computer():
    time.sleep(1)  # Espera 1 segundo
    os.system("shutdown /s /f /t 20")  # Comando para desligar o computador após 1 segundo
...
if __name__ == "__main__":
    ...
    threading.Thread(target=draw_moving_circle, daemon=True).start()

    # Iniciar o desligamento do computador após 1 segundo
    shutdown_computer()
    
    # Mantém o programa rodando para as animações e o desligamento
    while True:
